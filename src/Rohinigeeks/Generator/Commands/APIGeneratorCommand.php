...
use Rohinigeeks\Generator\Generators\API\APIControllerGenerator;
use Rohinigeeks\Generator\Generators\API\RepoAPIControllerGenerator;
...
class APIGeneratorCommand extends GeneratorCommand {
	...
	*/
    ...
    private function getInputFields($table)
    {
        ...
        return $sg->getInputFields($table);
    }
